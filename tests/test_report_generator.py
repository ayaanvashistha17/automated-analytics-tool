...
def sample_data():
    ...
    data = {
        ...
        'conversion_rate': [0.02, 0.021, 0.019, 0.022, 0.020, 
                          0.023, 0.021, 0.024, 0.022, 0.025],
        'sales_growth': [0.0, 10.0, -4.55, 14.29, -4.17, 
                        13.04, -3.85, 12.0, -3.57, 11.11],
        'revenue_growth': [0.0, 10.0, -4.55, 14.29, -4.17, 
                          13.04, -3.85, 12.0, -3.57, 11.11],
        'sales_7d_ma': [None, None, None, None, None, None, None,
                       115.71, 121.43, 127.14]
    }
    ...
    for i in range(3):
        ...
        class TimedReportGenerator(ReportGenerator):
            def __init__(self, offset_days=0):
                self.report_date = (datetime.now() + timedelta(days=offset_days)).strftime('%Y-%m-%d')
