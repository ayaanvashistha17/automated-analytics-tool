...
def sample_data():
    ...
    data = {
        ...
        'revenue': [1000.0, 1100.0, 1050.0, 1200.0, 1150.0, 
                   ...
                   1450.0, 1600.0, 1550.0, 1700.0, 1650.0,
                   1800.0, 1750.0, 1900.0, 1850.0, 2000.0],
        'users': [50, 55, 52, 60, 58, 65, 63, 70, 68, 75,
                  73, 80, 78, 85, 83, 90, 88, 95, 93, 100],
        'conversion_rate': [0.02, 0.021, 0.019, 0.022, 0.020, 
                          0.023, 0.021, 0.024, 0.022, 0.025,
                          0.024, 0.027, 0.025, 0.028, 0.026,
                          0.029, 0.027, 0.030, 0.028, 0.031]
    }
